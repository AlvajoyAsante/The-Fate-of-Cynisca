...
if (video_position + 1  >= video_length) { // if the video is very close to ending, close the video and do something; you can change the -5.0 to a better offset number to your liking, like -2.0 or anything else
	video_close()
	room_goto(goto_room)
}